...
public class Arrays {
    ...
    private Arrays() {
      ...
      //native edit
    private native int[] dsort(int[] arr);  //native method
    ...
    public static void sort(int[] a) {
       // sort1(a, 0, a.length);
	      System.out.println("In hardware Arrays.class");
              System.loadLibrary("java_util_Arrays");
	       Arrays dpq = new Arrays();
	      int[] tmp = new int[a.length];
	      tmp=dpq.dsort(a);
	      System.out.println("In hardware Arrasy.class");
	      for(int i=0;i<a.length;i++){
	        a[i] = tmp[i];
	        //System.out.println("inlib: "+a[i]);
	      }
    }
